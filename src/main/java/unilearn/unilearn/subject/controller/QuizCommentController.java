...
public class QuizCommentController {
    ...
    public ResponseEntity<List<QuizCommentForm>> comments(@PathVariable Long quizId){
    ...
    public ResponseEntity<QuizCommentForm> create(@Valid @RequestBody QuizCommentForm quizCommentForm, @PathVariable Long quizId){
